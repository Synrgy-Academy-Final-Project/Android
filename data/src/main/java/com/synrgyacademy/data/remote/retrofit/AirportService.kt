...
import com.synrgyacademy.data.remote.response.AllPromotionResponse
import com.synrgyacademy.data.remote.response.EticketResponse
import com.synrgyacademy.data.remote.response.GetDetailHistoryTransactionResponse
import com.synrgyacademy.data.remote.response.GetHistoryTransactionResponse
import com.synrgyacademy.data.remote.response.GetUserByTokenResponse
import com.synrgyacademy.data.remote.response.MinimumPriceResponse
import com.synrgyacademy.data.remote.response.PromotionResponse
import com.synrgyacademy.data.remote.response.ScheduleResponse
import com.synrgyacademy.data.remote.response.TransactionResponse
import com.synrgyacademy.data.remote.response.UserDetailResponse
